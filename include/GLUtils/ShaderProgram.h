...
public:
	...
	// Make sure you use this shader program before using the returned value in glUniform...
	GLuint getSubroutineIndex(const GLenum& type, const char* subroutineSelection) const;
	GLint getSubroutineLocation(const GLenum& type, const char* subroutineName) const;
